...
//*************************************************************************
// dibujar en modo seleccion practica 5
//*************************************************************************
 ...
 */
    ...
    ambiente = _vertex4f(0.105882,0.058824,0.113725, 1.0);
    difuso = _vertex4f(0.427451,0.470588,0.541176, 1.0);
...
caras[5]._0=3;caras[5]._1=2;caras[5]._2=1;
    ...
    colors_random();
    //practica 4 normales a caras
     ambiente = _vertex4f(0.2125, 0.1275, 0.054, 1.0);
    difuso = _vertex4f(0.714, 0.4284, 0.18144, 1.0);
...
int color=80;
piezas=11; //numero de piezas que tengo 
grosor_select=2;
...
glPushMatrix();
   ...
   //Ruedin ejez
    ...
    if (activo[0]==1) ruedin3.draw(EDGES, r_p, g_p, b_p, grosor_select);
else ruedin3.draw(modo, r, g, b, grosor);
    ...
    if (activo[1]==1) baseCamaratripode.draw(EDGES, r_p, g_p, b_p, grosor_select);
else baseCamaratripode.draw(modo, r, g, b, grosor);
       
    //Ruedin -x
    glTranslatef(-0.53,-1.38,0);//-0.11,-1.75,0
    glRotatef(giro_ruedin,0,1,0);
     if (activo[2]==1) ruedin1.draw(EDGES, r_p, g_p, b_p, grosor_select);
else ruedin1.draw(modo, r, g, b, grosor);
    ...
    glRotatef(giro_camara,0,1,0);
     if (activo[3]==1) basecirculo.draw(EDGES, r_p, g_p, b_p, grosor_select);
else basecirculo.draw(modo, r, g, b, grosor);
    ...
    if (activo[4]==1) ruedin2.draw(EDGES, r_p, g_p, b_p, grosor_select);
else ruedin2.draw(modo, r, g, b, grosor);
    ...
    glRotatef(movimientovertical,0,0,1);
     if (activo[5]==1) basecamara.draw(EDGES, r_p, g_p, b_p, grosor_select);
else basecamara.draw(modo, r, g, b, grosor);
    
    //detalles 1
    glTranslatef(0,0,0);
    glRotatef(0,0,0,0);  //glRotqatef(giro_camara,0,1,0);
    if (activo[6]==1) detalles.draw(EDGES, r_p, g_p, b_p, grosor_select);
else detalles.draw(modo, r, g, b, grosor);
    
    //detallaes pantalla inferior y varios
    glTranslatef(0,0,0);
    glRotatef(0,0,0,0);  //glRotqatef(giro_camara,0,1,0);
    if (activo[7]==1) detalles2.draw(EDGES, r_p, g_p, b_p, grosor_select);
else detalles2.draw(modo, r, g, b, grosor);
    
    //parte objetivo1 que no se mueve
    glTranslatef(basecirculo.ancho/2.0,0,0);
    glRotatef(0,0,0,0);
    if (activo[8]==1) objetivo1.draw(EDGES, r_p, g_p, b_p, grosor_select);
else objetivo1.draw(modo, r, g, b, grosor);

    //parte objetivo 2 que se mueve
    glTranslatef(zoom,0,0);
    glRotatef(0,0,0,0);
    if (activo[9]==1) objetivo2.draw(EDGES, r_p, g_p, b_p, grosor_select);
else objetivo2.draw(modo, r, g, b, grosor);
    
    //pantalla superior
    glTranslatef(-zoom,0,0);
    glTranslatef(-0.46,0.40,-0.00);
    glRotatef(giro_monitor,0,0,1);
    if (activo[10]==1) pantalla.draw(EDGES, r_p, g_p, b_p, grosor_select);
else pantalla.draw(modo, r, g, b, grosor);
...
glPushMatrix();
   //Ruedin ejez
    ...
    ruedin3.draw(SELECT, color.r, color.g, color.b, 1);
    ...
    baseCamaratripode.draw(SELECT, color.r, color.g, color.b, 1);
       
    //Ruedin -x
    glTranslatef(-0.53,-1.38,0);//-0.11,-1.75,0
    glRotatef(giro_ruedin,0,1,0);
    color=color_select[2];
    ruedin1.draw(SELECT, color.r, color.g, color.b, 1);
    ...
    basecirculo.draw(SELECT, color.r, color.g, color.b, 1);
    ...
    ruedin2.draw(SELECT, color.r, color.g, color.b, 1);
    ...
    basecamara.draw(SELECT, color.r, color.g, color.b, 1);
    
    //detalles 1
    glTranslatef(0,0,0);
    glRotatef(0,0,0,0);  //glRotqatef(giro_camara,0,1,0);
    color=color_select[6];
    detalles.draw(SELECT, color.r, color.g, color.b, 1);
    
    //detallaes pantalla inferior y varios
    glTranslatef(0,0,0);
    glRotatef(0,0,0,0);  //glRotqatef(giro_camara,0,1,0);
    color=color_select[7];
    detalles2.draw(SELECT, color.r, color.g, color.b, 1);
    
    //parte objetivo1 que no se mueve
    glTranslatef(basecirculo.ancho/2.0,0,0);
    glRotatef(0,0,0,0);
    color=color_select[8];
    objetivo1.draw(SELECT, color.r, color.g, color.b, 1);

    //parte objetivo 2 que se mueve
    glTranslatef(zoom,0,0);
    glRotatef(0,0,0,0);
    color=color_select[9];
    objetivo2.draw(SELECT, color.r, color.g, color.b, 1);
    ...
    pantalla.draw(SELECT, color.r, color.g, color.b, 1);
