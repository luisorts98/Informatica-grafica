...
_objeto_ply  ply;
_rotacion rotacion;
_cono cono(1,2,6);//radio, altura, numero de caras que tendrá por la rotación
_cilindro cilindro(1,2,6);//param radio, altura, numero de caras que tendrá, si pones más, será mas redondo
_esfera esfera(1, 16, 16);//en el primer parametro radio, numero de puntos, numero de caras que se generan por rotacón
_camara camara;
...
switch (Tecla1){
    ...
    case GLUT_KEY_PAGE_DOWN:Observer_distance/=1.2;break;
        //PRACTICA 3
    case GLUT_KEY_F1:camara.giro_camara+=5;break;//era giro_cabina
    case GLUT_KEY_F2:camara.giro_camara-=5;break; //era girno_camara11
