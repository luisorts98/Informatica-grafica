...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, CONO, CILINDRO, ESFERA, EXTRUSION} _tipo_objeto;
...
switch (t_objeto){
    case CUBO: cubo.draw(modo,0.0, 1.0, 1.0, 2.0);break;
    case PIRAMIDE: piramide.draw(modo,0.0, 0.0, 0.0, 2.0);break;
        case OBJETO_PLY: ply.draw(modo,1.0,0.6,0.0,5);break;
        case ROTACION: rotacion.draw(modo,0.0, 1.0, 1.0, 2.0);break;
        case EXTRUSION: extrusion->draw(modo,0.0, 0.0, 0.0, 5.0);break;
        case CONO: cono.draw(modo,0.0, 1.0, 1.0, 2.0);break;
...
switch (toupper(Tecla1)){
    ...
    case '4':modo=SOLID_COLORS;break;
        ...
        case 'T':t_objeto=EXTRUSION;break;
        case 'Y':t_objeto=CONO;break;
        case 'U':t_objeto=CILINDRO;break;
        case 'I':t_objeto=ESFERA;break;
    }
glutPostRedisplay();
}
...
rotacion.parametros(perfil,8,0,0,0,3);
